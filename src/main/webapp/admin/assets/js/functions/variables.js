...
var storeProductColumns = ['მაღაზია',strings["store_product_name"], strings["store_product_type"], strings["store_product_sub_type"], strings["store_product_price"],'წონა','კოდი'];
var orderProductColumns = ["ID",strings["admin_label_name"], strings["admin_label_phone"], strings["admin_label_date"], strings['admin_label_status'], strings['admin_label_region']];
var orderMonitoringColumns = ["კურიერი","მისამართი","კურიერის ტელ.","კლიენტის ტელ."];
var orderCourierColumns = ['id',strings["admin_label_name"], strings["admin_label_phone"], strings["admin_label_date"], strings['admin_label_status'], strings['admin_label_address']];

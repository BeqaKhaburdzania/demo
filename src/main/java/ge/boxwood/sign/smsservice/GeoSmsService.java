package ge.boxwood.sign.smsservice;

import ge.boxwood.sign.config.utils.MobileUtils;
import ge.boxwood.sign.smsservice.GeoSms.*;
...
public class GeoSmsService {
  ...
  private String messageSuffix = " - www.boxwood.ge";
